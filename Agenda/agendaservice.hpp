#ifndef AGENDASERVICE_HPP
#define AGENDASERVICE_HPP
...
class AgendaService {
   public:
     ...
     * @return if success, "" will be returned, else return the error message
     */
    std::string userLogIn(const std::string userName, const std::string password);
     ...
     * @return if success, "" will be returned, else return the error message
     */
    std::string userRegister(const std::string userName, const std::string password,
