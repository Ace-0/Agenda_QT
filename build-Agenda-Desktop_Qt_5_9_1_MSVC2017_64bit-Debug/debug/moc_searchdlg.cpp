/****************************************************************************
** Meta object code from reading C++ file 'searchdlg.hpp'
**
...
#include "../../Agenda/searchdlg.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'searchdlg.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 14), // "sendSearchDone"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13), // "receiveSearch"
QT_MOC_LITERAL(4, 40, 20), // "on_searchBtn_clicked"
QT_MOC_LITERAL(5, 61, 20) // "on_cancelBtn_clicked"

    },
    "SearchDlg\0sendSearchDone\0\0receiveSearch\0"
    "on_searchBtn_clicked\0on_cancelBtn_clicked"
};
...
void SearchDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSearchDone(); break;
        case 1: _t->receiveSearch(); break;
        ...
        {
            typedef void (SearchDlg::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchDlg::sendSearchDone)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SearchDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SearchDlg.data,
      qt_meta_data_SearchDlg,  qt_static_metacall, nullptr, nullptr}
};
